OFFER PACK, remediation services
Covers: Mold & Asbestos Services, Disaster Recovery Services, Waterproofing

---

## Core positioning sentence

"I help remediation and disaster recovery companies win the trust of homeowners who are frightened by a health or structural threat so they call that company before the insurance adjuster recommends one."

---

## One-line public offer

"I build high-converting websites for mold, disaster recovery, and waterproofing companies."

(For IG bio variant: "Websites for remediation companies that convert panic calls into booked jobs.")
...
| Growth (recommend this) | Full 5-page site, basic local SEO, certification display, process section, insurance claim help section, mobile-optimized | $1,800 |
| Pro | Full site + GBP optimization + 3-month SEO content plan + automation setup (emergency form + auto-reply) | $3,500 |
...
1. "came out the same day we called"
2. "explained exactly what the mold was and how it got there"
3. "helped us work with our insurance adjuster"
4. "the house passed the post-remediation test"
5. "sealed off the area so the rest of the house was safe"
6. "honest about what needed to come out and what didn't"
7. "documented everything for the insurance claim"
8. "we can breathe easy again -- literally"

---

## Top 3 trust elements to name in every DM

1. **IICRC certification and state license visible in the hero** (remediation work affects health -- mold and asbestos especially; the homeowner calling is scared, not shopping; the company that shows certification credentials immediately converts the fear into a call)
2. **Insurance claim assistance statement** (most remediation work is insurance-covered; the company that explicitly says "we work directly with your insurance adjuster and handle the documentation" wins every post-disaster call)
3. **Before/after remediation photos with clearance test mention** (homeowners want to see the problem gone and the space safe -- an "after" photo paired with a mention of post-remediation clearance testing converts the skeptical homeowner who wonders if the problem is really fixed)
...
Checked out [business name]. You have the certifications but your site has no IICRC badge visible in the hero and no insurance claim assistance section.

Those are the two things a frightened homeowner checks before calling. I'll redesign your homepage for free. If you like it, you pay. If not, no invoice.
...
I noticed [business name] has [specific thing you saw on their site, e.g. "IICRC certification buried in the About page" or "no insurance claim assistance section"].

I've been studying remediation and disaster recovery websites and the ones that convert have three things most sites skip: certifications visible in the hero, a plain insurance claim assistance statement, and before/after photos with clearance test mentions. Homeowners discovering mold or flood damage are in a mild panic -- they are not comparing five companies. They call the first one that looks certified and handles the insurance paperwork.
...
```
Subject: [Business name] -- one thing your site is missing that converts the frightened homeowner

Hey [first name],

I was looking at [business name] and noticed [specific observation: e.g. "your certifications are listed on the About page but not visible in the hero" or "there's no insurance claim assistance section on the homepage"].

That matters because remediation calls are driven by fear, not comparison shopping. A homeowner who just found mold behind the drywall or came home to a flooded basement is not requesting five quotes. They are calling the first company that looks credentialed, available, and capable of handling the insurance claim.

The remediation and disaster recovery websites that convert have three specific things: IICRC certification and state license in the hero, a plain insurance claim assistance statement, and before/after photos with post-remediation clearance test mentions.

I've built a template specifically for remediation companies that includes all three. I'd build your homepage using it for free. You see the result before paying a cent. If it works for you, we go from there. If not, I'll send you a $25 Starbucks card for your time.
...
### Prospect 1: PureAir Mold Remediation
**URL:** pureairmold.com
**Location:** Houston, TX
**Platform:** LinkedIn or cold email
**What they have:** WordPress site, IICRC certified but certification only on the About page. No insurance claim section. Before/after photos but no clearance test mention. 4.7 stars, 48 reviews. Reviews mention insurance help four times.
**Personalization angle:** "Your reviews mention insurance help four times but your homepage has no insurance claim section and the IICRC badge is only on the About page. The homeowner calling after finding mold doesn't scroll to the About page -- they call whoever looks most credentialed on the first screen."
**DM version:** Medium, adapted:

```
Hey [owner name],

PureAir has a 4.7 and your reviews mention insurance help four times. But the IICRC badge is only on the About page and there's no insurance claim section on the homepage.

The homeowner finding mold at midnight is calling the first company that looks certified and handles the insurance. I'll redesign your homepage for free to put both in the hero. You pay only if you like it.
...
### Prospect 2: DryFast Disaster Restoration
**URL:** dryfastrestoration.net
**Location:** Nashville, TN
**Platform:** Cold email
**What they have:** Squarespace site, mentions 24/7 emergency response. No IICRC badge in the hero. No insurance section. Before photos only -- no after photos or clearance tests. 4.4 stars, 33 reviews.
**Personalization angle:** "DryFast mentions 24/7 emergency but has no response time commitment, no IICRC badge in the hero, and before photos without the after. Homeowners calling after a flood want to see the problem gone, not just the damage."
**DM version:** Short, adapted:

```
Hey [owner name],

DryFast mentions 24/7 emergency but has no response time, no IICRC badge in the hero, and only before photos. Homeowners calling after a flood want to see the problem gone.
...
### Prospect 3: CleanSpace Waterproofing Solutions
**URL:** cleanspacewaterproofing.com
**Location:** Chicago, IL
**Platform:** Instagram or cold email
**What they have:** Active Instagram (900 followers, posts before/after basement waterproofing and drainage installs). Website is a Wix template with a form. No certifications, no insurance section.
**Personalization angle:** "CleanSpace posts great before/after waterproofing content on Instagram. None of that is on your website, and there's no warranty or certification visible anywhere."
**DM version:** Short, adapted:

```
Hey [owner name],

CleanSpace posts great before/after waterproofing content on Instagram. None of that is on your website. And there's no warranty or certification visible -- homeowners spending $8k on basement waterproofing want to see both before calling.
...
### Prospect 4: AirSafe Asbestos & Mold Services
**URL:** airsaferemediation.com
**Location:** Philadelphia, PA
**Platform:** Cold email
**What they have:** HTML site from 2014. Not mobile-optimized. Lists services. State license mentioned but no number shown. No before/after photos. 4.1 stars, 17 reviews.
**Personalization angle:** "AirSafe handles asbestos and mold but has no before/after photos and the state license is mentioned without a number. For health-related remediation, those two things are what a frightened homeowner checks before trusting anyone in their home."
**DM version:** Long, adapted:

```
Subject: AirSafe -- health remediation with no photos and no license number

Hey [owner name],

I checked airsaferemediation.com on my phone. The site is from 2014, doesn't load properly, and has no before/after photos. The state license is mentioned but no number is shown.

For asbestos and mold remediation, homeowners are scared about health. They are checking for two things before they call: credentials they can verify and proof the problem actually gets fixed. No license number and no before/after photos both fail that check.

I'd rebuild your homepage for free -- license number in the hero, IICRC badge, before/after photos, insurance claim section. You see it before paying anything. If it works, we go from there. If not, $25 Starbucks card.
...
### Prospect 5: Any mold, waterproofing, or disaster recovery company with 20 to 80 Google reviews in a humid-climate or flood-prone US city but certifications buried on the About page
**How to find them:** Search "mold remediation [target US city]" or "basement waterproofing [city]" on Google Maps in cities like Houston, Chicago, Nashville, Philadelphia, or Orlando. Sort by rating. Check the homepage hero for IICRC or state license. Most will have it buried in the About page or footer.
**Personalization angle:** "Your certification is your most important conversion signal for a frightened homeowner. It should be in the hero, not the footer."
**DM version:** Medium, with certification placement angle.
